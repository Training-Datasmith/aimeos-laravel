...
<?= $content ?>
		...
		<script src="<?= airoute('aimeos_shop_jqadm_file', [ 'site' => $site, 'locale' => 'en', 'name' => 'vendor-js' ]) ?>"></script>
		<script src="<?= airoute('aimeos_shop_jqadm_file', [ 'site' => $site, 'locale' => 'en', 'name' => 'index-js' ]) ?>"></script>
	</body>
</html>
