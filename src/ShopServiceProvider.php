 ...
 */
class Shop_Service_Provider extends Service_Provider
{
    /**
    ...
    {
        $this->load_views_from(dirname(__DIR__) . '/views', 'shop');
        $this->load_routes_from(dirname(__DIR__) . '/routes/aimeos.php');
        ...
        $class = \Composer\Installed_Versions::class;
        if (class_exists($class) && method_exists($class, 'getInstalledPackagesByType')) {
            foreach (\Composer\Installed_Versions::get_installed_packages_by_type('aimeos-extension') as $package) {
                $path = realpath(\Composer\Installed_Versions::get_install_path($package));
    ...
    {
        $this->merge_config_from(dirname(__DIR__) . '/config/default.php', 'shop');
        ...
        $this->commands([\Aimeos\Shop\Command\Account_Command::class, \Aimeos\Shop\Command\Clear_Command::class, \Aimeos\Shop\Command\Setup_Command::class, \Aimeos\Shop\Command\Jobs_Command::class]);
    }
    /**
    ...
    {
        return [\Aimeos\Shop\Base\Aimeos::class, \Aimeos\Shop\Base\I18n::class, \Aimeos\Shop\Base\Context::class, \Aimeos\Shop\Base\Config::class, \Aimeos\Shop\Base\Locale::class, \Aimeos\Shop\Base\View::class, \Aimeos\Shop\Base\Support::class, \Aimeos\Shop\Base\Shop::class, \Aimeos\Shop\Command\Account_Command::class, \Aimeos\Shop\Command\Clear_Command::class, \Aimeos\Shop\Command\Setup_Command::class, \Aimeos\Shop\Command\Jobs_Command::class];
    }
}